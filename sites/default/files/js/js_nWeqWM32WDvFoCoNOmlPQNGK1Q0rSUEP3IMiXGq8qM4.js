...
const icons_2 = document.querySelectorAll('.tab__icon2');
const hidden_info2 = document.querySelectorAll('.second-tab__info');
const tab_headers = document.querySelectorAll('.second-item__header');
/*
for this system, the active_index must be toggled and 
the requested index must be toggled
*/
function default_setup() {
    if(icons_2){
        icons_2[active_index].classList.toggle("tab__icon2--down");
    }
    
    hidden_info2[active_index].classList.toggle("second-tab__info--active");
    tab_headers[active_index].classList.toggle("second-item__header--active");
}

default_setup();
//default selected tab will be the first tab; can be randomized

icons_2.forEach((icon,index) => {
    icon.addEventListener('click', function(e) {
        if(index === active_index) {
            ...
            default_setup();
            icons_2[requested_index].classList.toggle("tab__icon2--down");
            hidden_info2[requested_index].classList.toggle("second-tab__info--active");
            tab_headers[requested_index].classList.toggle("second-item__header--active");
